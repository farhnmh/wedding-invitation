    ...
    const autoScroll = () => {
        ...
        const startScroll = () => {
            ...
            scrollInterval = setInterval(() => {
                // Add 100px margin to prevent bouncing and use smooth scroll
        ...
        // Resume after 3 seconds of no input
        let resumeTimeout;
        const handleInput = () => {
            clearTimeout(resumeTimeout);
            resumeTimeout = setTimeout(resumeScroll, 1000);
        };
